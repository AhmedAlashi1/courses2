...
{{--                        </li>--}}
                        ...
                        <li class="dropdown main-profile-menu nav nav-item nav-link">
                            <a class="profile-user d-flex" href=""><img alt="" src="{{ asset('dashboard/img/users/6.jpg') }}"></a>
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="{{ route('Admin.accountSettings') }}"><i class="bx bx-slider-alt"></i> Account Settings</a>
