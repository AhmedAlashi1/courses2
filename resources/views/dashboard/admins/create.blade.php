...
@section('title', __('messages.Add Admin') )
@section('content')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-body">
                    <form id="fileUploadForm" class="needs-validation was-validated" action="{{route('admins.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row row-sm">
                            ...
                            <div class="form-group col-md-6 has-success mg-t-10">
                                ...
                                <input value="{{old('email')}}" id="name_en" type="email" class="form-control " name="email"  required>
                                @error('email')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-md-12 has-success mg-t-10">
                                    ...
                                    {!! Form::select('roles[]', $roles,[], array('class' => 'form-control testselect2','multiple')) !!}
                                @error('roles')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
