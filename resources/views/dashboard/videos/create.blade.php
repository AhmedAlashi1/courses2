    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-body">
                    <form id="fileUploadForm" class="needs-validation was-validated" action="{{route('videos.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
...
{{--                                        @endforeach--}}
                            ...
                            <div class="form-group col-md-6 has-success mg-t-10">
                                ...
                                <input value="{{old('description_ar')}}" id="description_ar" type="text" class="form-control " name="description_ar"  required>
