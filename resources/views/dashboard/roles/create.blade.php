...
@section('title', __('messages.Add Role') )
@push('styles')
                                    ...
                                    <table class="table table-hover mb-0 text-md-nowrap text-center"> <!-- Add 'text-center' class here -->
                                        ...
                                        <tr>
                                            ...
                                            @foreach($permission['permissions'] as $row)
                                                <td>
                                                    <label class="checkbox-label">
                                                        {{ Form::checkbox('permission[]', $row, false, array('class' => 'checkbox-item')) }}
                                                        <div class="main-toggle main-toggle-success checkbox-item-toggle">
                                                            <span></span>
                                                        </div>
                                                    </label>
                                                </td>
